...
const Integration = () => {
  return (
    <>
      <section>
        <div className="mx-auto flex max-w-c-1390 flex-col items-center px-4 md:px-8 2xl:px-0">
          {/* <!-- Section Title Start --> */}
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Effortless Integrations to Empower Your Workflow`,
              description: `Seamlessly connect your favorite tools like Slack, Trello, Skype, and more to manage your data from anywhere, anytime. Boost productivity and streamline your operations with our reliable, secure integrations built for today's fast-paced digital world.`,
            }}
          />
          ...
          <a
            href="/auth/signup"
            className="mt-4 inline-flex items-center gap-2.5 rounded-full bg-primary px-6 py-3 font-medium text-white hover:opacity-90 dark:bg-white dark:text-black"
          >
