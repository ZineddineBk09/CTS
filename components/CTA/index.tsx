          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Get Started Today and Accelerate Your Success!
              </h2>
              <p>
                Unlock your full potential with our powerful tools and
                integrations designed to enhance productivity. Join our platform
                for free and experience seamless management, streamlined
                workflows, and unparalleled support to boost your business.
              </p>
            </motion.div>
            <motion.div
              variants={{
